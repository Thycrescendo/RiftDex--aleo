...
const Mailing: React.FC = () => {
  ...
  Stay in the Loop with RiftDex
</span>
<span className="text-darkGray font-Montserrat text-lg">
  Join our mailing list to stay updated on AI insights, Aleo blockchain updates, trading strategies, and new token discoveries on RiftDex. <br />
